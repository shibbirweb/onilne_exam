...
<div class="col-lg-6">
<span class="logo"></span>Online Exam</div>
<div class="col-md-2">
</div>
<div class="col-md-4">
<?php
...
<span href="#" data-target="#login" style="color:lightyellow">copyright Online Examination<br><br></span></div>
...
<div class="col-md-2 box">
<a href="about.php" s style="color:lightyellow;text-decoration:underline" onmouseover="this.style('color:yellow')">About </a></div>
</div>
</body>
</html>

    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        if ($status == "enabled") {
            ...
            <tr>
                ...
                <td style="vertical-align:middle"><b><a href="update.php?deidquiz=<?php echo $eid;  ?>" class="btn logb" style="color:#FFFFFF;background:#ff0000;font-size:12px;padding:5px;">&nbsp;<span><b>Disable</b></span>
                        </a>
                    </b>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="vertical-align:middle"><b><a href="update.php?eeidquiz=<?php echo $eid ; ?>" class="btn logb" style="color:#FFFFFF;background:darkgreen;font-size:12px;padding:5px;">&nbsp;<span><b>Enable</b></span>
                        </a>
                    </b>
                </td>
            </tr>

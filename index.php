...
function validateForm() {
  ...
  if (m.length < 3) {
    document.getElementById("errormsg").innerHTML="Phone number must be 3 digits long";
    return false;
  }
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="rollno" name="rollno" placeholder="Enter your Roll no " class="form-control input-md" type="text" value="
<?php
echo @$_GET['rollno'];
?>">
...
<div class="form-group">
  ...
  <div class="col-md-12">
    <input id="username" name="username" placeholder="Choose a username or enter email" class="form-control input-md" type="username" value="<?php
echo @$_GET['username'];
?>" style="<?php
if (isset($_GET['q7']))
...
<span href="#" data-target="#login" style="color:lightyellow">copyright to Online Exam<br><br></span></div>
<div class="col-md-2 box">
<a href="feedback.php" style="color:lightyellow;" onmouseover="this.style('color:yellow')" target="new">Feedback</a></div>
<div class="col-md-2 box">
<a href="about.php" s style="color:lightyellow;" onmouseover="this.style('color:yellow')" target="new">About Online Exam</a></div>
</div>
